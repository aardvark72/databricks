...
# Only completed orders for historical data
...
def generate_historical_orders(num_orders=8000, months_back=6):
    ...
    print(
        f"Generating {num_orders} orders from {start_date.date()} to {end_date.date()}")
